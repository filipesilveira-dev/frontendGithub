...
export default function NovaTarefa() {
  ...
  // Desestruturação de objeto: função para adicionar ao estado global e estado global para mostrar a quantidade de tarefas no aaray
  const { addTarefa, tarefas } = useTarefaStore();
  ...
  return (
    <div>
      <span>Você tem {tarefas.length} tarefa(s)</span>
